				...
				<?php
					...
					foreach($_SESSION['list'] as $testimon)
					{
						if($testimon->optradio == 'b')
								echo '<div class="panel panel-danger"><div class="panel-heading"><h4>' . addslashes($testimon->name) . '</h4></div><div class="panel-body"><h4>' . addslashes($testimon->msg) . '</h4></div></div>';
						else
								echo '<div class="panel panel-success"><div class="panel-heading"><h4>' . addslashes($testimon->name) . '</h4></div><div class="panel-body"><h4>' . addslashes($testimon->msg) . '</h4></div></div>';
					}
				?>    			
  			</div>
		</div>
