...
<html lang="en">
	<head>
  	...
  	<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navigator">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="level2.php">Level 2</a></li>
		...
		<div class="container">
		  <form action="testify2.php" role="form" method="post">
...
&lt;&#47;script&gt;</code></li>
			...
			<div class="panel-group" id="accordion5">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="panel-title">
							<a href="#collapse-5" data-toggle="collapse" data-parent="#accordion5">
								+ Hint 5
							</a>
						</div><!-- End panel title -->
						...
						<div id="collapse-5" class="panel-collapse collapse">
							<div class="panel-body">
								<ul class="list-group">
									<li class="list-group-item "><code>&lt;img src=&quot;image.gif&quot; onerror=javascript:alert(123)&gt;</code></li>
								</ul>
								<div class="alert alert-danger alert-dismissable">
  									<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  									This XSS attack does the job.
  								</div>								
							</div>
						</div><!-- End Panel collapse -->						
					</div>
