			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navigator">
					<ul class="nav navbar-nav">
						<li><a href="#">Home</a></li>
						<li class="active"><a href="#stuff">Testimonials</a></li>
				...
				<?php
					...
					foreach($_SESSION['list'] as $testimon)
					{
						if($testimon->optradio == 'b')
								echo '<div class="panel panel-danger"><div class="panel-heading"><h4>' . $testimon->name . '</h4></div><div class="panel-body"><h4>' . $testimon->msg . '</h4></div></div>';
						else
								echo '<div class="panel panel-success"><div class="panel-heading"><h4>' . $testimon->name . '</h4></div><div class="panel-body"><h4>' . $testimon->msg . '</h4></div></div>';
					}
				?>    			
  			</div>
		</div>
